...
jQuery.validator.setDefaults({
  ...
  errorPlacement: function (error, element) {
    if (
      element.parent().hasClass("jq-checkbox") ||
      element.parent().hasClass("jq-radio")
    ) {
  ...
  highlight: function (element, errorClass, validClass) {
    if (
      $(element).parent().hasClass("jq-checkbox") ||
      $(element).parent().hasClass("jq-radio") ||
      $(element).parent().hasClass("jq-selectbox")
    ) {
...
// Form.html - validation form

$("#inplace_form").validate({
  errorElement: "span",
